...
플러그인의 기원은 녹음 및 믹싱 스튜디오에서 쓰이던 각종 장비들을 디지털로 구현한 것입니다.  
하나의 곡을 완성하기 위해 필요한 기능들을 컴퓨터에서도 쓰기 위해 만들어진 것이죠.  

플러그인은 작은 디지털 파일의 형태를 가지고 있습니다.  
...
현재 음향에서 말하는 플러그인이란 Steinberg에서 개발한 VST 표준을을 따르는 동적 라이브러리를 말합니다.  
