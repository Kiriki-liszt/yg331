...
또한, 이는 루프백을 사용할 수 없는 오인페의 경우이니, 루프백을 사용하는 방식은 다른 포스트로 설명하겠습니다.  
...
제일 무난하게 어디에도 어울리고 보컬을 받쳐주는 스타일은 Hall 그룹의 프로그램들입니다.  
취향에 따라 보컬을 화려하게 돋보이게 해주는 타입인 Plate나 Chamber를 골라도 좋습니다.  
...
그 다음 아래쪽에 있는 파라미터들을 조절해 톤을 조절합니다.  
